(ns strojure.zmap.impl.clj-test
  (:require [clojure.test :as test :refer [deftest testing]]
            [strojure.zmap.impl.clj :as impl*]
            [strojure.zmap.impl.core :as impl])
...
(def ^:private -e
  (#'impl*/boxed-map-entry :k (impl/boxed-delay :x)))
